    ...
    <div>
      ...
      <div className="bg-gray-200 px-4 pt-4 pb-6 rounded-b-3xl shadow-md mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 w-full md:w-[65%]">
        ...
        <div className="flex items-center gap-3">
          <img
            src={user} // Ensure this path is correct or use a placeholder
            alt="profile"
...
<div className='bg-gray-200 px-8 py-3 mx-auto grid grid-cols-1 md:grid-cols-1 gap-4 w-full md:w-[65%] rounded-lg'>
