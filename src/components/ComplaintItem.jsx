        ...
        <div className="bg-gray-200 min-h-screen">
            ...
            <div className="p-8 px-4">
                <div className="relative bg-white rounded-2xl shadow-[0_4px_6px_rgba(75,75,75,0.45)] p-4 w-[45%] mt-4 mx-auto">
                    ...
                    {/* Button */}
                    <Link to="/Page_45">
                        <button className="mt-4 w-full bg-green-700 text-white text-sm shadow-lg rounded-full flex justify-center text-center mx-auto py-1 px-4 relative cursor-pointer">
                            Chat / Call
