        ...
        <div className="mx-auto px-2 py-2 mb-2 mt-5 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {services.map((service, index) => (
                <div key={index} className="flex items-center gap-3 bg-gray-50 border border-gray-300 rounded-md p-3">
          ...
          <div ref={imageSectionRef} className="space-y-4 scroll-mt-20">
            ...
            <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="aspect-square bg-gray-100 rounded-md border border-gray-500 flex items-center justify-center cursor-pointer hover:bg-gray-200">
          ...
          <div ref={videoSectionRef} className="space-y-4 scroll-mt-50">
            ...
            <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
                {[1, 2, 3, 4].map((item) => (
                <div key={item} className="aspect-square border border-gray-500 rounded-md flex items-center justify-center hover:bg-gray-50 cursor-pointer">
